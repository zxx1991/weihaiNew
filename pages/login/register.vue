	...
	<view class="aui-content zcbox p-l-1 p-r-1 bg-white">
		<form  @submit="formSubmit" @reset="">
			<view class="aui-list-item">
				<input class="in-put"  name="auth_code" placeholder="上级邀请码" placeholder-style="font-size:20rpx"/>
			</view>
			<view class="aui-list-item">
			...
			<view class="aui-list-item">
				<input class="in-put"  name="username" placeholder="请输入姓名" placeholder-style="font-size:20rpx"/>
			</view>
			<view class="aui-list-item">
				<input class="in-put"  name="pwd" password="true" placeholder="请输入密码" placeholder-style="font-size:20rpx"/>
			</view>
			<view class="aui-list-item">
				<input class="in-put" name="re_pwd" password="true" placeholder="请再输一遍密码" placeholder-style="font-size:20rpx"/>
			</view>
			<button type="primary" form-type="submit" style="font-size: 32rpx;margin-top: 40rpx;margin-bottom: 40rpx;">注册</button>
		</form>
